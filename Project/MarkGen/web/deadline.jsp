    ...
    <body>
        ...
        <div class="container-fluid bg-primary" style="padding-top: 70px;padding-bottom: 70px;" id="main-content">
            <div class="row" style="height: 100%;">
                <div class="col-xs-12">
                    <form action="MainServlet" method="post" class="col-xs-4 col-xs-offset-4 form-horizontal">
                        <div class="form-group">
                            <label class="" for="year">Batch</label>
                            <span class="">
                                <input type="text" name="year" id="year" class="form-control">
                            </span>
                        </div>
                        <div class="form-group">
                            <label class="" for="sem">Semester</label>
                        ...
                        <div class="form-group">
                            <label class="" for="det">Designation</label>
                            <select class="form-control" id="det" name="det">
                                <option value="T1">Terminal 1</option>
                                <option value="T2">Terminal 2</option>
                                <option value="M">Model</option>
                                <option value="AS">Assignments</option>
                                <option value="AS">Cycle Test</option>
                            </select>
                        </div>
                        <div class="form-group">
