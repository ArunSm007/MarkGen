                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="updateStudent.jsp" title="">
                                        <span class="glyphicon glyphicon-wrench"></span>
                                        &nbsp;Update Student
                                    </a>
                                </li>
        ...
        <div class="container-fluid bg-primary" style="padding-top: 70px;padding-bottom: 70px;" id="main-content">
            <div class="row" style="height: 100%;">
                <div class="col-xs-12 bg-default" style="height:100%;">
                    <form action="MainServlet" method="post" class="form-horizontal col-xs-6 col-xs-offset-3" style="height:100%;padding-top: 20px;">
                            ...
                            <div class="form-group" style="padding-top:20px;">
                                <label class="control-label">What do you want to change ?</label>
                            </div>
